...
<body>
<center>
	<img src="assets/img/error.png" style="width:20%;margin-top:100px;margin-bottom:20px;"><br>
	<p style="color:#AAA;font-weight:bold;font-size:20px;">ACCESS DENIED</p><br>
