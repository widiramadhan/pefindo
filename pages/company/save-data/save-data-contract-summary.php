<?php
/* CONTRACT SUMMARY DEBTOR Company*/
...
$callContDebtor = "{call SP_INSERT_CONTRACT_SUMARY_DEBTOR_COMPANY(?,?,?,?,?,?,?,?,?,?)}";
...
// CONTRACT SUMMARY GUARANTOR Company
...
$callContGuarantor = "{call SP_INSERT_CONTRACT_SUM_GUARANTOR_COMPANY(?,?,?,?,?,?,?,?,?,?)}";
...
//CONTRACT OVERALL Company mmasih error
...
$callContOverall = "{call SP_INSERT_CONTRACT_SUM_OVERALL_COMPANY(?,?,?,?,?,?)}";
...
//CONTRACT PAYMENT CALENDER LIST Company
