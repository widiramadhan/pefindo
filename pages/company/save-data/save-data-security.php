<?php
/* SECURITY LIST */
if(isset($array['GetCustomReportResponse']['GetCustomReportResult']['aSecurities']['bSecurityList']['bSecurity']['bAcquisitionAmount'])){
	...
	if($array['GetCustomReportResponse']['GetCustomReportResult']['aSecurities']['bSecurityList']['bSecurity']['bContractStatus']<>NULL){$SecurityContractStatus=$array['GetCustomReportResponse']['GetCustomReportResult']['aSecurities']['bSecurityList']['bSecurity']['bContractStatus'];}else{$SecurityContractStatus=NULL;}
	...
	if($array['GetCustomReportResponse']['GetCustomReportResult']['aSecurities']['bSecurityList']['bSecurity']['bSecurityType']<>NULL){$SecurityType=$array['GetCustomReportResponse']['GetCustomReportResult']['aSecurities']['bSecurityList']['bSecurity']['bSecurityType'];}else{$SecurityType=NULL;}
