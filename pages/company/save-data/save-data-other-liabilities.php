...
if(isset($array['GetCustomReportResponse']['GetCustomReportResult']['aOtherLiabilities']['bOtherLiabilityList']['bOtherLiability']['bContractCode'])){
	...
	if($array['GetCustomReportResponse']['GetCustomReportResult']['aOtherLiabilities']['bOtherLiabilityList']['bOtherLiability']['bStatus']<>NULL){$OtherLiabilitiesContractStat = $array['GetCustomReportResponse']['GetCustomReportResult']['aOtherLiabilities']['bOtherLiabilityList']['bOtherLiability']['bStatus'];}else{$OtherLiabilitiesContractStat=NULL;}
	if($array['GetCustomReportResponse']['GetCustomReportResult']['aOtherLiabilities']['bOtherLiabilityList']['bOtherLiability']['bType']<>NULL){$OtherLiabilitiesContractType = $array['GetCustomReportResponse']['GetCustomReportResult']['aOtherLiabilities']['bOtherLiabilityList']['bOtherLiability']['bType'];}else{$OtherLiabilitiesContractType=NULL;}
	...
	if($array['GetCustomReportResponse']['GetCustomReportResult']['aOtherLiabilities']['bOtherLiabilityList']['bOtherLiability']['bDefaultDescription']<>NULL){$OtherLiabilitiesDefaultReasonDesc = $array['GetCustomReportResponse']['GetCustomReportResult']['aOtherLiabilities']['bOtherLiabilityList']['bOtherLiability']['bDefaultDescription'];}else{$OtherLiabilitiesDefaultReasonDesc=NULL;}
	...
	$paramsOtherLiabilitiesList = array(
						...
						array(NULL,SQLSRV_PARAM_IN),//$OtherLiabilitiesBranch					
						...
						array(NULL,SQLSRV_PARAM_IN),//$OtherLiabilitiesPastDueDays
						array(NULL,SQLSRV_PARAM_IN),//$OtherLiabilitiesPreviousContCode
	...
	if(isset($array['GetCustomReportResponse']['GetCustomReportResult']['aOtherLiabilities']['bOtherLiabilityList']['bOtherLiability'])){
		foreach($array['GetCustomReportResponse']['GetCustomReportResult']['aOtherLiabilities']['bOtherLiabilityList']['bOtherLiability'] as $itemOtherLiabilitiestList){
			...
			if($itemOtherLiabilitiestList['bStatus']<>NULL){$OtherLiabilitiesContractStat = $itemOtherLiabilitiestList['bStatus'];}else{$OtherLiabilitiesContractStat=NULL;}
			if($itemOtherLiabilitiestList['bType']<>NULL){$OtherLiabilitiesContractType = $itemOtherLiabilitiestList['bType'];}else{$OtherLiabilitiesContractType=NULL;}
			...
			if($itemOtherLiabilitiestList['bDefaultDescription']<>NULL){$OtherLiabilitiesDefaultReasonDesc = $itemOtherLiabilitiestList['bDefaultDescription'];}else{$OtherLiabilitiesDefaultReasonDesc=NULL;}
			...
			$paramsOtherLiabilitiesList = array(
								...
								array(NULL,SQLSRV_PARAM_IN),
								array(NULL,SQLSRV_PARAM_IN),//$OtherLiabilitiesBranch					
								array($OtherLiabilitiesCondDate,SQLSRV_PARAM_IN),//$OtherLiabilitiesCondDate
								array($OtherLiabilitiesContractDate,SQLSRV_PARAM_IN),//$OtherLiabilitiesContractDate
								array($OtherLiabilitiesContractStat,SQLSRV_PARAM_IN),//$OtherLiabilitiesContractStat
								array($OtherLiabilitiesContractType,SQLSRV_PARAM_IN),//$OtherLiabilitiesContractType
								array($OtherLiabilitiesCreditor	,SQLSRV_PARAM_IN),//$OtherLiabilitiesCreditor					
								array($OtherLiabilitiesCurContract,SQLSRV_PARAM_IN),//$OtherLiabilitiesCurContract
								array($OtherLiabilitiesDefaultDate,SQLSRV_PARAM_IN),//$OtherLiabilitiesDefaultDate
								array($OtherLiabilitiesDefaultReason,SQLSRV_PARAM_IN),//$OtherLiabilitiesDefaultReason
								array($OtherLiabilitiesDefaultReasonDesc,SQLSRV_PARAM_IN),//$OtherLiabilitiesDefaultReasonDesc
								array($OtherLiabilitiesDeliqDate,SQLSRV_PARAM_IN),//$OtherLiabilitiesDeliqDate					
								array(NULL,SQLSRV_PARAM_IN),//$OtherLiabilitiesDesc
								array($OtherLiabilitiesInitTotAmountCur,SQLSRV_PARAM_IN),
								array($OtherLiabilitiesInitTotAmountVal,SQLSRV_PARAM_IN),
								array(NULL,SQLSRV_PARAM_IN),//$OtherLiabilitiesInterestRate
								array($OtherLiabilitiesIssueDate,SQLSRV_PARAM_IN),//$OtherLiabilitiesIssueDate					
								array($OtherLiabilitiesLastUpt,SQLSRV_PARAM_IN),//OtherLiabilitiesLastUpt
								array($OtherLiabilitiesMarketValCur,SQLSRV_PARAM_IN),
								array($OtherLiabilitiesMarketValVal,SQLSRV_PARAM_IN),
								array($OtherLiabilitiesMaturyDate,SQLSRV_PARAM_IN),//$OtherLiabilitiesMaturyDate
								array($OtherLiabilitiesNegativeStat,SQLSRV_PARAM_IN),//$OtherLiabilitiesNegativeStat					
								array($OtherLiabilitiesOutStandAmountCur,SQLSRV_PARAM_IN),
								array($OtherLiabilitiesOutStandAmountVal,SQLSRV_PARAM_IN),
								array(NULL,SQLSRV_PARAM_IN),//$OtherLiabilitiesPastDueDays
								array(NULL,SQLSRV_PARAM_IN),//$OtherLiabilitiesPreviousContCode
								array($OtherLiabilitiesPrincipalArreasCur,SQLSRV_PARAM_IN),					
								array($OtherLiabilitiesPrincipalArreasVal,SQLSRV_PARAM_IN),
								array($OtherLiabilitiesRating,SQLSRV_PARAM_IN),//$OtherLiabilitiesRating
								array($OtherLiabilitiesRealDate,SQLSRV_PARAM_IN));//$OtherLiabilitiesRealDate
			$execOtherLiabilitiesList = sqlsrv_query($conn, $callOtherLiabilitiesList, $paramsOtherLiabilitiesList) or die ( print_r( sqlsrv_errors(),true));
		}
	}
}
