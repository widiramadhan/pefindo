...
if(isset($array['GetCustomReportResponse']['GetCustomReportResult']['aCollaterals']['bCollateralList']['bCollateral']['bAppraisalValue'])){
	if(isset($array['GetCustomReportResponse']['GetCustomReportResult']['aCollaterals']['bCollateralList']['bCollateral']['bAppraisalValue']['cCurrency'])){
		if($array['GetCustomReportResponse']['GetCustomReportResult']['aCollaterals']['bCollateralList']['bCollateral']['bAppraisalValue']['cCurrency']<>NULL){$AppraiseCur=$array['GetCustomReportResponse']['GetCustomReportResult']['aCollaterals']['bCollateralList']['bCollateral']['bAppraisalValue']['cCurrency'];}else{$AppraiseCur=NULL;}
		if($array['GetCustomReportResponse']['GetCustomReportResult']['aCollaterals']['bCollateralList']['bCollateral']['bAppraisalValue']['cValue']<>NULL){$AppraiseVal=$array['GetCustomReportResponse']['GetCustomReportResult']['aCollaterals']['bCollateralList']['bCollateral']['bAppraisalValue']['cValue'];}else{$AppraiseVal=NULL;}					
	}else{
		$AppraiseCur=NULL;
		$AppraiseVal=NULL;
	}
	if(isset($array['GetCustomReportResponse']['GetCustomReportResult']['aCollaterals']['bCollateralList']['bCollateral']['bBankValue']['cCurrency'])){
	...
	$callCollateralList = "{call SP_INSERT_COLLATERAL_LIST(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}";
	...
	if(isset($array['GetCustomReportResponse']['GetCustomReportResult']['aCollaterals']['bCollateralList']['bCollateral'])){
		foreach($array['GetCustomReportResponse']['GetCustomReportResult']['aCollaterals']['bCollateralList']['bCollateral'] as $itemCol_List){
			if(isset($itemCol_List['bAppraisalValue']['cCurrency'])){
				if($itemCol_List['bAppraisalValue']['cCurrency']<>NULL){$AppraiseCur=$itemCol_List['bAppraisalValue']['cCurrency'];}else{$AppraiseCur=NULL;}
				if($itemCol_List['bAppraisalValue']['cValue']<>NULL){$AppraiseVal=$itemCol_List['bAppraisalValue']['cValue'];}else{$AppraiseVal=NULL;}
			}else{
				$AppraiseCur=NULL;
				$AppraiseVal=NULL;
			}
			if(isset($itemCol_List['bBankValue']['cCurrency'])){
...
$callCollateralSUM = "{call SP_INSERT_COLLATERAL_SUMMARY(?,?,?,?,?,?,?,?)}";
