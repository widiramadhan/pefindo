<?php
/* Subject Info Header */
$callSubInfoHistory = "{call SP_INSERT_SUBJECT_INFO_HISTORY(?,?)}";
...
$callSubInfoHistoryID = "{call SP_GET_SUBJECT_INFO_HISTORY(?)}";
...
if(isset($array['GetCustomReportResponse']['GetCustomReportResult']['aSubjectInfoHistory']['bContactList']['bContact']['bItem'])){
	...
	$callSubInfoHisContList = "{call SP_INSERT_SUBJECT_INFO_HISTORY_CONTACTLIST(?,?,?,?,?,?,?)}";
	...
	if(isset($array['GetCustomReportResponse']['GetCustomReportResult']['aSubjectInfoHistory']['bContactList']['bContact'])){
...
if(isset($array['GetCustomReportResponse']['GetCustomReportResult']['aSubjectInfoHistory']['bGeneralList']['bGeneral']['bItem'])){
	...
	$callSubInfoHisGenList = "{call SP_INSERT_SUBJECT_INFO_HISTORY_GENERALLIST(?,?,?,?,?,?,?)}";
	...
	if(isset($array['GetCustomReportResponse']['GetCustomReportResult']['aSubjectInfoHistory']['bGeneralList']['bGeneral'])){
...
if(isset($array['GetCustomReportResponse']['GetCustomReportResult']['aSubjectInfoHistory']['bIdentificationsList']['bIdentifications']['bItem'])){
	...
	$callSubInfoHisIdentList = "{call SP_INSERT_SUBJECT_INFO_HISTORY_IDENTIFICATIONSLIST(?,?,?,?,?,?,?)}";
	...
	if(isset($array['GetCustomReportResponse']['GetCustomReportResult']['aSubjectInfoHistory']['bIdentificationsList']['bIdentifications'])){
