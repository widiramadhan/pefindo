...
//if(isset($array['GetCustomReportResponse']['GetCustomReportResult']['aContracts']['bContractList']['bContract']['bBankBeneficiary'])){	
	if(isset($array['GetCustomReportResponse']['GetCustomReportResult']['aContracts']['bContractList']['bContract']['bConditionDate'])){
	$v=0;
	$x=0;
	$y=0;
	$z=0;
	...
	if($array['GetCustomReportResponse']['GetCustomReportResult']['aContracts']['bContractList']['bContract']['bDefaultDescription']<>NULL){$ConctDefaultReasonDesc=$array['GetCustomReportResponse']['GetCustomReportResult']['aContracts']['bContractList']['bContract']['bDefaultDescription'];}else{$ConctDefaultReasonDesc=NULL;}
	...
	//if($array['GetCustomReportResponse']['GetCustomReportResult']['aContracts']['bContractList']['bContract']['bGuarantyDeposit']<>NULL){$ConctGuarantDepo=$array['GetCustomReportResponse']['GetCustomReportResult']['aContracts']['bContractList']['bContract']['bGuarantyDeposit'];}else{$ConctGuarantDepo=NULL;}
	...
	//if(isset($array['GetCustomReportResponse']['GetCustomReportResult']['aContracts']['bContractList']['bContract']['bInterestRate'])){
	//	if($array['GetCustomReportResponse']['GetCustomReportResult']['aContracts']['bContractList']['bContract']['bInterestRate']<>NULL){$ConctInterestRate=$array['GetCustomReportResponse']['GetCustomReportResult']['aContracts']['bContractList']['bContract']['bInterestRate'];}else{$ConctInterestRate=NULL;}
	//}else{
	//	$ConctInterestRate=NULL;
	//}
	//if(isset($array['GetCustomReportResponse']['GetCustomReportResult']['aContracts']['bContractList']['bContract']['bInterestRateType'])){
		//if($array['GetCustomReportResponse']['GetCustomReportResult']['aContracts']['bContractList']['bContract']['bInterestRateType']<>NULL){$ConctInterestRateType=$array['GetCustomReportResponse']['GetCustomReportResult']['aContracts']['bContractList']['bContract']['bInterestRateType'];}else{$ConctInterestRateType=NULL;}			
	//}else{
		//$ConctInterestRateType=NULL;
	//}
	...
	//if($array['GetCustomReportResponse']['GetCustomReportResult']['aContracts']['bContractList']['bContract']['bLastInterestRate']<>NULL){$ContLastIntersRate=$array['GetCustomReportResponse']['GetCustomReportResult']['aContracts']['bContractList']['bContract']['bLastInterestRate'];}else{$ContLastIntersRate=NULL;}
	//if($array['GetCustomReportResponse']['GetCustomReportResult']['aContracts']['bContractList']['bContract']['bLastInterestRateType']<>NULL){$ContLastIntersRateType=$array['GetCustomReportResponse']['GetCustomReportResult']['aContracts']['bContractList']['bContract']['bLastInterestRateType'];}else{$ContLastIntersRateType=NULL;}
	...
	//if($array['GetCustomReportResponse']['GetCustomReportResult']['aContracts']['bContractList']['bContract']['bProjectValue']<>NULL){$ConctProjVal=$array['GetCustomReportResponse']['GetCustomReportResult']['aContracts']['bContractList']['bContract']['bProjectValue'];}else{$ConctProjVal=NULL;}
	...
	$a=NULL;
	$callContract = "{call SP_INSERT_CONTRACT(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}";
	$paramsContract = array(
									array($mappingId, SQLSRV_PARAM_IN),
									array($pefindoId,SQLSRV_PARAM_IN),
									array(null,SQLSRV_PARAM_IN),//$ConctBankBenefic
									array(null,SQLSRV_PARAM_IN),//$ConctBranch
									...
									array(null,SQLSRV_PARAM_IN),//$ConctSubType
									array($ConctType,SQLSRV_PARAM_IN),
									array(null,SQLSRV_PARAM_IN),//$ConctCreditChar
									...
									array(null,SQLSRV_PARAM_IN),//$ConctDescription
									...
									array(null,SQLSRV_PARAM_IN),//$ConctGovernProg
									array($a,SQLSRV_PARAM_IN),
									array($ConctInitialAgrmntDate,SQLSRV_PARAM_IN),
									array($ConctInitialAgrmntNumb,SQLSRV_PARAM_IN),
									array(null,SQLSRV_PARAM_IN),//$ConctInterestRate
									array(null,SQLSRV_PARAM_IN),//$ConctInterestRateType
									array(null,SQLSRV_PARAM_IN),//$ConctInitRestcDate
									...
									array(null,SQLSRV_PARAM_IN), //$ContLastIntersRate
									array(null,SQLSRV_PARAM_IN), //$ContLastIntersRateType
									...
									array(null,SQLSRV_PARAM_IN),//$ConctProjLoc
									array($a,SQLSRV_PARAM_IN),
									array(null,SQLSRV_PARAM_IN),//$ConctProloCounter
									array($ConctPurposeFinance,SQLSRV_PARAM_IN),
									array($ConctRealandDate,SQLSRV_PARAM_IN),
									array(NULL,SQLSRV_PARAM_IN),//$ConctRestrucCount
									array($ConctRestrucDate,SQLSRV_PARAM_IN),
									array(NULL,SQLSRV_PARAM_IN),//$ConctRestrucReason
	...
	/* Get ID Contract */
	$callContractID = "{call SP_GET_ID_M_CONTRACT(?,?)}";
	...
	/*if($array['GetCustomReportResponse']['GetCustomReportResult']['aContracts']['bContractList']['bContract'][$x]['bCollateralsList']<>NULL){
		if(isset($array['GetCustomReportResponse']['GetCustomReportResult']['aContracts']['bContractList']['bContract'][$x]['bCollateralsList']['bCollateral']['bAppraisalValue']['cCurrency'])){
			...
			if($array['GetCustomReportResponse']['GetCustomReportResult']['aContracts']['bContractList']['bContract'][$x]['bCollateralsList']['bCollateral']['bBranch']<>NULL){$ContCollListBranch=$array['GetCustomReportResponse']['GetCustomReportResult']['aContracts'][$x]['bContractList']['bContract']['bCollateralsList']['bCollateral']['bBranch'];}else{$ContCollListBranch=NULL;}
			...
			$callContractCollateralList = "{call SP_INSERT_M_CONTRACT_COLLATERAL_LIST(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}";
			...
			if(isset($array['GetCustomReportResponse']['GetCustomReportResult']['aContracts']['bContractList']['bContract'][$x]['bCollateralsList']['bCollateral'])){
				foreach($array['GetCustomReportResponse']['GetCustomReportResult']['aContracts']['bContractList']['bContract'][$x]['bCollateralsList']['bCollateral'] as $itemContCollList){								
					...
					echo"<script>alert('test ->".$itemContCollList['bCollateralCode']."');</script>";
					$callContractCollateralList = "{call SP_INSERT_M_CONTRACT_COLLATERAL_LIST(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}";
					$paramsContractCollateralList = array(
													array($mappingId, SQLSRV_PARAM_IN),
													array($Contract_ID,SQLSRV_PARAM_IN),
	...
	$v=0;
	/* Insert to disputes list where contract id */
	if(isset($array['GetCustomReportResponse']['GetCustomReportResult']['aContracts']['bContractList']['bContract'][$v]['bDisputeList'])){
		if($array['GetCustomReportResponse']['GetCustomReportResult']['aContracts']['bContractList']['bContract'][$v]['bDisputeList']<>NULL){
			if(isset($array['GetCustomReportResponse']['GetCustomReportResult']['aContracts']['bContractList']['bContract'][$v]['bDisputes']['bDisputeList']['bDispute']['bComment'])){
				if($array['GetCustomReportResponse']['GetCustomReportResult']['aContracts']['bContractList']['bContract'][$v]['bDisputes']['bDisputeList']['bDispute']['bComment']<>NULL){$ContComment=$array['GetCustomReportResponse']['GetCustomReportResult']['aContracts']['bContractList']['bContract'][$v]['bDisputes']['bDisputeList']['bDispute']['bComment'];}else{$ContComment=NULL;}
				if($array['GetCustomReportResponse']['GetCustomReportResult']['aContracts']['bContractList']['bContract'][$v]['bDisputes']['bDisputeList']['bDispute']['bCreated']<>NULL){$ContCreated=$array['GetCustomReportResponse']['GetCustomReportResult']['aContracts']['bContractList']['bContract'][$v]['bDisputes']['bDisputeList']['bDispute']['bCreated'];}else{$ContCreated=NULL;}
				if($array['GetCustomReportResponse']['GetCustomReportResult']['aContracts']['bContractList']['bContract'][$v]['bDisputes']['bDisputeList']['bDispute']['bResolution']<>NULL){$ContResolution=$array['GetCustomReportResponse']['GetCustomReportResult']['aContracts']['bContractList']['bContract'][$v]['bDisputes']['bDisputeList']['bDispute']['bResolution'];}else{$ContResolution=NULL;}
				if($array['GetCustomReportResponse']['GetCustomReportResult']['aContracts']['bContractList']['bContract'][$v]['bDisputes']['bDisputeList']['bDispute']['bStatus']<>NULL){$ContStatus=$array['GetCustomReportResponse']['GetCustomReportResult']['aContracts']['bContractList']['bContract'][$v]['bDisputes']['bDisputeList']['bDispute']['bStatus'];}else{$ContStatus=NULL;}
				
				$callContractDisputeList = "{call SP_INSERT_M_CONTRACT_DISPUTE_LIST(?,?,?,?,?,?)}";
				$paramsContractDisputeList = array(
												array($mappingId, SQLSRV_PARAM_IN),
												array($Contract_ID,SQLSRV_PARAM_IN),
												array($ContComment,SQLSRV_PARAM_IN),
												array($ContCreated,SQLSRV_PARAM_IN),
												array($ContResolution,SQLSRV_PARAM_IN),
												array($ContStatus,SQLSRV_PARAM_IN)
												);
				$execContractDisputeList = sqlsrv_query($conn, $callContractDisputeList, $paramsContractDisputeList) or die ( print_r( sqlsrv_errors(),true));
				$v++;
			}else{
				if(isset($array['GetCustomReportResponse']['GetCustomReportResult']['aContracts']['bContractList']['bContract'][$v]['bDisputes']['bDisputeList']['bDispute'])){
					foreach($array['GetCustomReportResponse']['GetCustomReportResult']['aContracts']['bContractList']['bContract'][$v]['bDisputes']['bDisputeList']['bDispute'] as $itemContDisList){								
						if($itemContDisList['bComment']<>NULL){$ContComment=$itemContDisList['bComment'];}else{$ContComment=NULL;}
						if($itemContDisList['bCreated']<>NULL){$ContCreated=$itemContDisList['bCreated'];}else{$ContCreated=NULL;}
						if($itemContDisList['bResolution']<>NULL){$ContResolution=$itemContDisList['bResolution'];}else{$ContResolution=NULL;}
						if($itemContDisList['bStatus']<>NULL){$ContStatus=$itemContDisList['bStatus'];}else{$ContStatus=NULL;}
	...
	if(isset($array['GetCustomReportResponse']['GetCustomReportResult']['aContracts']['bContractList']['bContract'][$y]['bPaymentCalendarList']['bCalendarItem']['bDate'])){
		...
		$callContractPayCalenderList = "{call SP_INSERT_M_CONTRACT_PAYMENT_CALENDAR_LIST(?,?,?,?,?,?,?,?,?,?,?)}";
		$paramsContractPayCalenderList = array(
										...
										array(NULL,SQLSRV_PARAM_IN),//$ContPayCalenderIntRate
	...
	if(isset($array['GetCustomReportResponse']['GetCustomReportResult']['aContracts']['bContractList']['bContract'][$z]['bRelatedSubjectsList']['bRelatedSubject']['bExpectedEndDate'])){
		...
		$callContractRelatedSubjec = "{call SP_INSERT_M_CONTRACT_RELATED_SUBJECT(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}";
		$paramsContractRelatedSubjec = array(
										array($mappingId, SQLSRV_PARAM_IN),
										array($Contract_ID,SQLSRV_PARAM_IN),
										array(NULL,SQLSRV_PARAM_IN),//$ContRelatedSubExpect
										array(NULL,SQLSRV_PARAM_IN),//$ContRelatedSubGuarancyDesc
										array(NULL,SQLSRV_PARAM_IN),//$ContRelatedSubGuarantAmount
										array(NULL,SQLSRV_PARAM_IN),//$ContRelatedSubJointAccSeq
										...
										array(NULL,SQLSRV_PARAM_IN),//$ContRelatedSubRealDate
										array($ContRelatedSubRegistNumb,SQLSRV_PARAM_IN),
										array($ContRelatedSubRoleClient,SQLSRV_PARAM_IN),
										array(NULL,SQLSRV_PARAM_IN),//$ContRelatedSubStartDate
	...
	if(isset($array['GetCustomReportResponse']['GetCustomReportResult']['aContracts']['bContractList']['bContract'])){
		foreach($array['GetCustomReportResponse']['GetCustomReportResult']['aContracts']['bContractList']['bContract'] as $itemContract){
			...
			if($itemContract['bDefaultDescription']<>NULL){$ConctDefaultReasonDesc=$itemContract['bDefaultDescription'];}else{$ConctDefaultReasonDesc=NULL;}
			...
			//if($itemContract['bGuarantyDeposit']<>NULL){$ConctGuarantDepo=$itemContract['bGuarantyDeposit'];}else{$ConctGuarantDepo=NULL;}
			...
			//if($itemContract['bLastInterestRate']<>NULL){$ContLastIntersRate=$itemContract['bLastInterestRate'];}else{$ContLastIntersRate=NULL;}			
			//if($itemContract['bLastInterestRateType']<>NULL){$ContLastIntersRateType=$itemContract['bLastInterestRateType'];}else{$ContLastIntersRateType=NULL;}
			...
			//if($itemContract['bProjectValue']<>NULL){$ConctProjVal=$itemContract['bProjectValue'];}else{$ConctProjVal=NULL;}			
			...
			$paramsContract = array(
										...
										array($ConctNameInsured,SQLSRV_PARAM_IN),
										array($ConctNegativeStatContact,SQLSRV_PARAM_IN),
										array(NULL,SQLSRV_PARAM_IN),//$ConctOrietationUse
										array($ConctOutStandingAmountCur,SQLSRV_PARAM_IN),
										array($ConctOutStandingAmountVal,SQLSRV_PARAM_IN),
										array($ConctPastDueAmountCur,SQLSRV_PARAM_IN),
										array($ConctPastDueAmountVal,SQLSRV_PARAM_IN),
			...
			if(isset($array['GetCustomReportResponse']['GetCustomReportResult']['aContracts']['bContractList']['bContract'][$z]['bRelatedSubjectsList']['bRelatedSubject']['bExpectedEndDate'])){
				...
				if(isset($array['GetCustomReportResponse']['GetCustomReportResult']['aContracts']['bContractList']['bContract'][$z]['bRelatedSubjectsList']['bRelatedSubject'])){
					foreach($array['GetCustomReportResponse']['GetCustomReportResult']['aContracts']['bContractList']['bContract'][$z]['bRelatedSubjectsList']['bRelatedSubject'] as $ItemContRelatedSub){
						...
						//if($ItemContRelatedSub['bGuaranteeAmount']<>NULL){$ContRelatedSubGuarantAmount=$ItemContRelatedSub['bGuaranteeAmount'];}else{$ContRelatedSubGuarantAmount=NULL;}
						//if($ItemContRelatedSub['bJointAccountSequence']<>NULL){$ContRelatedSubJointAccSeq=$ItemContRelatedSub['bJointAccountSequence'];}else{$ContRelatedSubJointAccSeq=NULL;}
						if(isset($ItemContRelatedSub['bName'])){
							if($ItemContRelatedSub['bName']<>NULL){$ContRelatedSubName=$ItemContRelatedSub['bName'];}else{$ContRelatedSubName=NULL;}
						}else{
							$ContRelatedSubName=NULL;
						}
						if(isset($ItemContRelatedSub['bNationalID'])){
							if($ItemContRelatedSub['bNationalID']<>NULL){$ContRelatedSubNational=$ItemContRelatedSub['bNationalID'];}else{$ContRelatedSubNational=NULL;}
						}else{
							$ContRelatedSubNational=NULL;
						}
						if(isset($ItemContRelatedSub['bPassportNumber'])){
							if($ItemContRelatedSub['bPassportNumber']<>NULL){$ContRelatedSubPassportNumb=$ItemContRelatedSub['bPassportNumber'];}else{$ContRelatedSubPassportNumb=NULL;}
						}else{
							$ContRelatedSubPassportNumb=NULL;
						}
						//if($ItemContRelatedSub['bRealEndDate']<>NULL){$ContRelatedSubRealDate=$ItemContRelatedSub['bRealEndDate'];}else{$ContRelatedSubRealDate=NULL;}
						if(isset($ItemContRelatedSub['bRegistrationNumber'])){
							if($ItemContRelatedSub['bRegistrationNumber']<>NULL){$ContRelatedSubRegistNumb=$ItemContRelatedSub['bRegistrationNumber'];}else{$ContRelatedSubRegistNumb=NULL;}
						}else{
							$ContRelatedSubRegistNumb=NULL;
						}
						if(isset($ItemContRelatedSub['bRoleOfClient'])){
							if($ItemContRelatedSub['bRoleOfClient']<>NULL){$ContRelatedSubRoleClient=$ItemContRelatedSub['bRoleOfClient'];}else{$ContRelatedSubRoleClient=NULL;}
						}else{
							$ContRelatedSubRoleClient=NULL;
						}
						//if($ItemContRelatedSub['bStartDate']<>NULL){$ContRelatedSubStartDate=$ItemContRelatedSub['bStartDate'];}else{$ContRelatedSubStartDate=NULL;}
						if(isset($ItemContRelatedSub['bSubjectType'])){
							if($ItemContRelatedSub['bSubjectType']<>NULL){$ContRelatedSubType=$ItemContRelatedSub['bSubjectType'];}else{$ContRelatedSubType=NULL;}
						}else{
							$ContRelatedSubType=NULL;
						}
						if(isset($ItemContRelatedSub['bTaxNumber'])){
							if($ItemContRelatedSub['bTaxNumber']<>NULL){$ContRelatedSubTaxNumb=$ItemContRelatedSub['bTaxNumber'];}else{$ContRelatedSubTaxNumb=NULL;}	
						}else{
							$ContRelatedSubTaxNumb=NULL;
						}
